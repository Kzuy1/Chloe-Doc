...
### Solução
Seguir o tutorial para Configurar Layers corretamente.
...
### Solução
Como extrair atributos de blocos para verificação?
...
### Solução
Utilizar o código Lisp AtualizaCodigoLegenda para arrumar Codigo de Identificação
...
## Solução
Como extrair atributos dos blocos para verificar a soma?
